...
def process_and_visualize_events(meta_tree, output_tree, genie_tree):
    ...
    for i in range(num_events):
        ...
        origin = (-18000, 18000, mid_z + max_z_range * 0.8) # Move legend to top in Z as well
        arrow_length = 4000
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--ratpac', required=True, help="Path to the RATPAC output file.")
