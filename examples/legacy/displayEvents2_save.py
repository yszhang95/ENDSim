...
#RATPAC_FILE = 'output_out.numu_100000.rootracker.29800-29900.randomVtx.display_29800_29900.root'
#RATPAC_FILE = 'output_out.numu_100000.rootracker.43800-43900.randomVtx.displayFlat_43800_43900.root'
#RATPAC_FILE = 'output_out.numu_100000.rootracker.71600-71700.randomVtx.displayFlat_71600_71700.root'
#RATPAC_FILE = 'output_out.numu_100000.rootracker.6100-6200.randomVtx.displayFlat_6100_6200.root'
...
ANGLE_TOLERANCE_COS = 1 # Tolerance for the cosine of the angle
...
def process_and_visualize_events(meta_tree, output_tree, genie_tree):
    ...
    for i in range(num_events):
        ...
        # Add coordinate system legend at the top
        origin = (-18000, 18000, mid_z)
        arrow_length = 4000
        ...
        ax.text(origin[0] + arrow_length*1.1, origin[1], origin[2], " +X", color='k', fontsize=14)
        ax.text(origin[0], origin[1] + arrow_length*1.1, origin[2], " +Y (Water Surface)", color='k', fontsize=14)
        ax.text(origin[0], origin[1], origin[2] + arrow_length*1.1, " +Z (Beam Direction)", color='k', fontsize=14)
